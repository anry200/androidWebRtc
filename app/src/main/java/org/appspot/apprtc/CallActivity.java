...
//    }
      ...
      DataChannelParameters dataChannelParameters =
              new DataChannelParameters(true, -1,-1, "",false, -1);
  ...
  public void onPeerConnectionError(final String description) {
    ...
    @Override
    public void onIncomingMessage(final String message) {
      runOnUiThread(new Runnable() {
          @Override
          public void run() {
              chatFragment.addIncomingMessage(message);
          }
      });
    }
    ...
    public void sendFile(final String path) {
        peerConnectionClient.sendFile(path);
    }
}
